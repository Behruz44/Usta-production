    ...
    <footer>
      <div className="container footer-inner">
        ...
        <div className="footer-col">
          ...
          <a href="https://wa.me/996312000000" className="footer-link" target="_blank">WhatsApp</a>
          <a href="https://t.me/usta_osh" className="footer-link" target="_blank">Telegram</a>
          <a href="tel:+996312000000" className="footer-link">Позвонить</a>
        </div>
      </div>
