              ...
              {addressDropdownOpen && (
                <div className="dropdown open" onClick={(e) => e.stopPropagation()}>
                  ...
                  <div className="drop-item">
                    ...
                    <div>
                      <div style={{ fontSize: '13.5px', fontWeight: '700', color: 'var(--ink)' }}>Пн–Сб</div>
            ...
            <div className="modal">
              ...
              <div className="modal-body">
                ...
                <div className="modal-actions">
                  ...
                  <button className="modal-btn modal-btn-main" onClick={() => { window.location.href = `tel:+996312000000`; }}>
                    <Phone size={16} />
                    Позвонить
                  </button>
                </div>
